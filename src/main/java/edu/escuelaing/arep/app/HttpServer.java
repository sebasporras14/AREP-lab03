...
public class HttpServer {
    ...
    public static void start(String[] args) throws Exception {
        ...
        while (true) {
            ...
            URI filePath = new URI("/target/classes/edu/escuelaing/arep/app/resources/public" + path);
            service s = MiniSpark.search(functPath.getPath(), method);
            try {
                if(s != null){
    ...
    private static void manageFile(URI filePath, Socket clientSocket) throws Exception {
        ...
        if (!file.exists()) {
            fileController = new text(clientSocket, "html", new URI("/target/classes/edu/escuelaing/arep/app/resources/public" + "/error101.html"));
